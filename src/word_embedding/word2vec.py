...
class MyWord2Vec():
	def __init__(self):
		self.model_name = "../../data/word_embedding/word2vec.model.txt"
	...
	def train(self):
		...
		self.model = Word2Vec(sentences, workers=num_workers, size=num_features, iter=iteration, window=context, min_count=1)
